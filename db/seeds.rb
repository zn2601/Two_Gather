...
user12 = User.create(email: "user12@admin.com", password: "123123", name: "Elena", zipcode: "1016 HE", about_me: "Hi everyone! I'm Elena, a tech guru with a knack for troubleshooting. From setting up your new gadgets to solving computer glitches, I'm here to make our community tech-savvy and connected. Let's navigate the digital world together!")
